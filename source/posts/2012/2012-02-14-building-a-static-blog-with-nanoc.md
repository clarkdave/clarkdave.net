...
This is using the _Rendering_ helper we included earlier, and is rendering the `default` layout but passing in additional content (the markup for a blog post).
